...
import com.sai.canteen.ModelClass.Cart;
import com.sai.canteen.ModelClass.Order;
import com.sai.canteen.ModelClass.Payment;
...
//        webview.loadUrl("https://www.youtube.com/@GameZonedYT");


        int amount = Utils.paidAmount;
        Utils.showOrder = false;

        try {
            String postData = "Name=" + URLEncoder.encode(Utils.currentUser.getName(), "UTF-8") +
                    "&Amount=" + URLEncoder.encode(String.valueOf(amount), "UTF-8");
            webview.postUrl("http://192.168.1.105:3000/api/payment", postData.getBytes(StandardCharsets.UTF_8));
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // Inject JavaScript to close the window if payment is confirmed
//                view.evaluateJavascript("if (window.confirmPayment) { window.confirmPayment(); }", null);
            }
//            @Override
//            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
//                Uri uri = request.getUrl();
//                String message = ((Uri) uri).getQueryParameter("message");
//                if (message != null && message.equals("PaymentConfirmed")) {
//                    // Payment confirmed, handle accordingly
//                    // For example, close the activity
//                    closeScreen(PaymentActivity.this);
//                }
