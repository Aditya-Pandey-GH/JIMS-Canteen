package com.sai.canteen.Fragment;
...
import com.sai.canteen.CategoryActivity;
import com.sai.canteen.Constant;
import com.sai.canteen.FoodlistActivity;
import com.sai.canteen.ModelClass.Kitchen;
import com.sai.canteen.R;
...
public class HomeFragment extends Fragment {
	...
	private FirebaseRecyclerAdapter<com.sai.canteen.ModelClass.Kitchen, KitchenViewHolder> adapter;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		RecyclerView recycler = view.findViewById(R.id.recycler_cate);
		recycler.setHasFixedSize(true);
		LinearLayoutManager manager = new LinearLayoutManager(ctx, LinearLayoutManager.HORIZONTAL, false);
		recycler.setLayoutManager(manager);
		CategoryAdapter categoryAdapter = new CategoryAdapter(ctx);
		recycler.setAdapter(categoryAdapter);

		recyclerView = view.findViewById(R.id.recycler_kitchen);
...
//                }
	...
	private class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.UserViewHolder> {
		...
		@Override
		public void onBindViewHolder(CategoryAdapter.UserViewHolder holder, @SuppressLint("RecyclerView") final int position) {
