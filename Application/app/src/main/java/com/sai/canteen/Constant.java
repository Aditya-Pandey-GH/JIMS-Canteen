...
public class Constant {
    ...
    public static final String SharedPrefName = "JimsCanteen";
    public static final String CartPrefName = "Cart";
    public static final String PAYMENT_URL = "";
    public static final String INTERFACE = "azbasdeftghukoiytsxcvbklpoiwertyuioplkjhgzxcbnr";
