...
public class SidebarAdapter extends RecyclerView.Adapter<SidebarAdapter.UserViewHolder> {
    ...
    public SidebarAdapter(Context ctx, DrawerLayout drawer) {
        ...
        titleList.add("Join Us");
        titleList.add("Privacy Policy");
        titleList.add("Share App");
        titleList.add("Contact Us");
        titleList.add("Rate Us");
        titleList.add("Terms and Conditions");
        titleList.add("About Us");

        iconList.add(R.drawable.ic_vendor);
        iconList.add(R.drawable.lock);
        iconList.add(R.drawable.share);
        iconList.add(R.drawable.email);
        iconList.add(R.drawable.rate);
        iconList.add(R.drawable.term);
        iconList.add(R.drawable.info);

        subtitleList.add("Join as a Vendor");
        subtitleList.add("Terms & Policies");
        subtitleList.add("Help us to build big family");
        subtitleList.add("Share your thought with us");
        subtitleList.add("Give your rate and feedback");
        subtitleList.add("Terms and Conditions");
        subtitleList.add("About Us");
    }
