...
import com.sai.canteen.ModelClass.Food;
            ...
            public void onClick(View v) {
                if(Utils.categoryData.getStatus().toUpperCase().equals("OPEN")) {
                    if (coun[0] > 0) {
                        ...
                        Cart cart = new Cart("Canteen Special","https://i.ibb.co/zHhRBSz/410px-Thali-svg.png",Utils.categoryData.getDefaultPrice(),coun[0],Utils.categoryData.getName());
